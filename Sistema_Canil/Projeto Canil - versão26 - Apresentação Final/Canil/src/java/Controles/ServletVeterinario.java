        ...
        if (acao.equals("Cadastrar")) {
            ...
            if (nome.equals("") || email.equals("") || usuario.equals("") || senha.equals("")) {
                ...
                try {
                    ...
                    response.sendRedirect("/Canil/capa.jsp?IDPagina=telaSucesso&IDTela=cadVeterinario");
            ...
            if (!nome.equals("")) {
                ...
                request.setAttribute("listar", vet);
                RequestDispatcher rd = getServletContext().getRequestDispatcher("/capa.jsp?IDPagina=pesqVeterinario&Nome=" + nome);
                rd.forward(request, response);
            }
