...
<%@page import="Controles.ServletAnimal"%>
<%@page import="Controles.ServletAnimal"%>
<%@page import="Objetos.Baia"%>
<%@page import="java.util.ArrayList"%>

<%@include file="ServletAnimal.java"%>
<%@include page="listarAnimais.jsp"%>
...
<form method="POST" action="ServletAnimal"> 
    <fieldset> 
        ...
        <p class="barra" > </p>
        <p>
            <label class="col-lg-3 control-label"> Nome do Animal: </label>
